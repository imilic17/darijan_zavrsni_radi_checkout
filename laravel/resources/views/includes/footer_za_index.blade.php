    ...
    <a href="https://youtube.com/yourchannel" class="text-white social-icon" target="_blank">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-md-end">
                <img src="/zavrsni/dodatne_slike_za_index/googlepay-logo.png" alt="GooglePay" width="65" height="45" class="me-2">
                <img src="/zavrsni/dodatne_slike_za_index/visa.png" alt="Visa" width="65" height="45" class="me-2">
                <img src="/zavrsni/dodatne_slike_za_index/mastercard.png" alt="Mastercard" width="65" height="45" class="me-2">
                <img src="/zavrsni/dodatne_slike_za_index/diners.png" alt="Diners" width="65" height="45">
            </div>
        </div>
    </div>
</footer>
